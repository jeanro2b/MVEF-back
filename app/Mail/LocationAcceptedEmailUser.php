...
class LocationDemandEmailUser extends Mailable
{
     ...
     * @return void
     */
    public function __construct( $reservationId, $destinationName, $yearStart, $monthStart, $dayStart, $yearEnd, $monthEnd, $dayEnd, $destination_id, $amount, $output, $filename)
    {
