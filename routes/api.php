...
Route::get('check-code/{code}/{destination}', [CodeController::class, 'check_code'])
    ->name('check_code');
...
Route::get('/download-facture-reservation/{id}', [ReservationController::class, 'download_facturation_reservation'])
